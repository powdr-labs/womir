...
crush transforms a WebAssembly program into an intermediate representation (IR). In this IR, WASM local variables and the operand stack are represented
as edges of a directed acyclic graph (DAG). From this structure, crush can generate a user-defined, assembly-like representation of the program.

## Targets

crush can target ISAs for machines with arbitrarily many general-purpose registers,
...
- [powdr-wasm](https://github.com/powdr-labs/powdr-wasm)

## Interpreter

crush has its own generic ISA and a corresponding [interpreter](https://github.com/powdr-labs/powdr-wasm/tree/main/src/interpreter) that supports both execution models and is used for testing.
